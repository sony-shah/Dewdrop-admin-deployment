                ...
                <ul>
                    ...
                    <li className='form-row'>
                        ...
                        <div className='multipleitem'>
                            ...
                            <inyput id="gallaryimg" type="file"
                                // name="gallaryImages"
                                multiple
                                required
                    ...
                    {/* <li className='form-row'>
                        ...
                        <div className='multipleitem'>
                            ...
                            <label htmlFor='productImagesid' className='custom-file-upload'> File upload  </label>
                            ...
                            <span>{ProductsUrls && ProductsUrls.map((productUrls, j) => (
                            // console.log(productUrls),
                         <ul key={j}> <li> <a href={productUrls}>{productUrls}</a></li> </ul> 
